...
public class RegisterUIFromVideo extends BaseFaceTracker {
    private View mView;
    ...
    public RegisterUIFromVideo(Activity activity, CameraController cameraController) {
        super(activity, cameraController);
    }

    @Override
    public View createView(LayoutInflater inflater, @Nullable ViewGroup container) {
        View v = inflater.inflate(R.layout.register_from_video, null);
        container.addView(v);
