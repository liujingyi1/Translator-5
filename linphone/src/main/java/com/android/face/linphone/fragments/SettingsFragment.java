...
import com.android.face.linphone.ui.LedPreference;
import com.android.face.linphone.ui.PreferencesListFragment;
    ...
    private void initVideoSettings() {
        ...
        for (final PayloadType pt : lc.getVideoCodecs()) {
            ...
            if (lc.openH264Enabled()) {
                // modify by David , we have load H264 codec by default!
